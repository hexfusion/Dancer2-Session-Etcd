...
use Dancer2::Session::Etcd::Serializer::JSON;
...
is(
    exception { $serializer = Dancer2::Session::Etcd::Serializer::JSON->new },
    undef, "new with no args lived",
);

isa_ok( $serializer, "Dancer2::Session::Etcd::Serializer::JSON" );
...
is(
    exception { $serializer = Dancer2::Session::Etcd::Serializer::JSON->new( serialize_options => { pretty => 1 }) },
