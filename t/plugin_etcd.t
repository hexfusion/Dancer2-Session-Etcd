...
BEGIN {
    eval "use Dancer2";
    eval "use Dancer2::Plugin::Etcd 0.0009";
    plan skip_all => "Dancer2::Plugin::Etcd 0.0009 required to run this test"
      if $@;
}

diag "Dancer2::Plugin::Etcd version: ", $Dancer2::Plugin::DBIC::VERSION;
use Plack::Test;
